...
class TabCNN(BaseTabModel):
    ...
    def __init__(self, config: dict, **kwargs):
        ...
        # --- 1. Adım: Tüm CNN Dallarını Oluştur ---
        ...
        for feature_key in self.active_features:
            ...
            else: # hcqt, mel gibi spektral özellikler için
        ...
        # --- BU FOR DÖNGÜSÜ YUKARIDA BİTTİ ---

        # --- 2. Adım: Projeksiyonları ve Kafa Boyutunu Hesapla ---
        ...
        # --- 3. Adım: Backbone ve Head'leri Oluştur ---
